...
| T07 | Lab admin | Nonsensitive cloud app | Push/TOTP only; strong method registered | CA001 + CA002 | CA002 `reportOnlyUserActionRequired` or result explained from actual claim; no prompt from report-only | Strong method required; weak-only attempt cannot complete | Sign-in auth/CA detail |
